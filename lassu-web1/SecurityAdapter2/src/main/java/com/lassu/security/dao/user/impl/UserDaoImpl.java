...
public class UserDaoImpl implements UserDao {
	...
	private static String RETRIEVE_SQL_BY_USERNAME = "SELECT * FROM lassu.web_y_user_detail where username =:username";
	private static String INSERT_SQL = "INSERT INTO lassu.web_y_user_detail_audit ("
			+ " audit_id, user_id, reporting_site, crtn_ts" + ") VALUES ("
			+ " :audit_id, :user_id, :reporting_site, now()" + ")";
	private static String UPDATE_SQL = "SELECT * FROM lassu.web_y_user_detail where user_id = ? for update";
	...
	public User findUserByUsername(String username) {
		...
		if (System.getProperty("site.code").equalsIgnoreCase("1")) {
			RETRIEVE_SQL_BY_USERNAME = "SELECT * FROM lassu.web_x_user_detail where username =:username";
		}
	...
	public User update(User user, String reportingSite) {
		...
		if (System.getProperty("site.code").equalsIgnoreCase("1")) {
			INSERT_SQL = "INSERT INTO lassu.web_x_user_detail_audit ("
					+ " audit_id, user_id, reporting_site, crtn_ts" + ") VALUES ("
					+ " :audit_id, :user_id, :reporting_site, now()" + ")";
		}
	...
	private void update(User user) {
		...
		if (System.getProperty("site.code").equalsIgnoreCase("1")) {
			UPDATE_SQL = "SELECT * FROM lassu.web_x_user_detail where user_id = ? for update";
		}
