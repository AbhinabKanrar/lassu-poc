...
import com.lassu.security.service.AuthChRespkAuditConsumer;
...
public class BootLoader implements CommandLineRunner {
	...
	@Autowired
	private AuthChRespkAuditConsumer authChRespkAuditConsumer;

	@Override
	public void run(String... args) throws Exception {
		eventBus.on($(CommonConstant.COMPONENT_AUTHCHK_RESP_AUDIT_DISPATCHER), authChRespkAuditConsumer);
	}
