...
public class UserDaoImpl implements UserDao {
	...
	private static final String INSERT_SQL = "INSERT INTO lassu.web_y_user_detail_audit ("
			+ " audit_id, user_id, reporting_site, crtn_ts" + ") VALUES ("
			+ " :audit_id, :user_id, :reporting_site, now()" + ")";
	private static final String UPDATE_SQL = "SELECT * FROM lassu.web_y_user_detail where user_id = ? for update";
